...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Zo(){return new Yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Qo(){return new Yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
...
`)+`
`+f);const T=R+p+a,C=R+f+o,I=al(r,r.VERTEX_SHADER,T),P=al(r,r.FRAGMENT_SHADER,C);r.attachShader(x,I),r.attachShader(x,P),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function L(F){if(i.debug.checkShaderErrors){const B=r.getProgramInfoLog(x).trim(),D=r.getShaderInfoLog(I).trim(),j=r.getShaderInfoLog(P).trim();let J=!0,z=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,I,P);else{const oe=ol(r,I,"vertex"),G=ol(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
